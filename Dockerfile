...
ARG KEYCLOAK_CLIENT_ID_JALAN_AING
ARG KEYCLOAK_CLIENT_SECRET_JALAN_AING
ARG X_PARTNER_ID
ARG GOOGLE_MAPS_API
ARG URL_FILE
ARG NODE_ENV
...
ARG UNLEASH_TOKEN
ARG METADATA_SECRET
ARG JALAN_AING_GEOSERVER_USERNAME
ARG JALAN_AING_GEOSERVER_PASSWORD
...
ENV BASE_URL_GATEWAY_PARTNER=$BASE_URL_GATEWAY_PARTNER
ENV BASE_URL_MAIN=$BASE_URL_MAIN
...
ENV KEYCLOAK_CLIENT_ID_JALAN_AING=$KEYCLOAK_CLIENT_ID_JALAN_AING
ENV KEYCLOAK_CLIENT_SECRET_JALAN_AING=$KEYCLOAK_CLIENT_SECRET_JALAN_AING
ENV X_PARTNER_ID=$X_PARTNER_ID
ENV GOOGLE_MAPS_API=$GOOGLE_MAPS_API
ENV URL_FILE=$URL_FILE
ENV NODE_ENV=$NODE_ENV
ENV UNLEASH_URL=$UNLEASH_URL
ENV UNLEASH_TOKEN=$UNLEASH_TOKEN
ENV METADATA_SECRET=$METADATA_SECRET
ENV JALAN_AING_GEOSERVER_USERNAME=$JALAN_AING_GEOSERVER_USERNAME
ENV JALAN_AING_GEOSERVER_PASSWORD=$JALAN_AING_GEOSERVER_PASSWORD
