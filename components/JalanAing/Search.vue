<template>
  <div class="flex items-center w-full max-w-xl lg:max-w-2xl">
    <ValidationObserver
      v-slot="{ invalid }"
    ...
    >
      ...
      >
        <JdsInputText
          id="search"
          v-model="searchQuery"
          class="w-full text-sm text-gray-700 bg-transparent focus:outline-none dark:border-dark-emphasis-medium"
