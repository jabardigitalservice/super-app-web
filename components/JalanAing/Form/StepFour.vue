      ...
      >
        ...
        >
          ...
          <template #suffix-icon>
            ...
            <button
              v-else
              class="text-sm font-lato font-semibold"
              :class="
                isLocationPickerDisabled
                  ? 'text-gray-400 cursor-not-allowed'
                  : 'text-green-700'
              "
              :disabled="isLocationPickerDisabled"
...
export default {
  ...
  computed: {
    ...
    place() {
      return this.$store.state['jalan-aing'].lokasi_aduan.place
    },
    address() {
      return this.$store.state['jalan-aing'].lokasi_aduan.place.address
    },
    setValueAddressDetail() {
      return this.$store.state['jalan-aing'].lokasi_aduan.address_detail
    },
    setValueCity: {
      get() {
        return this.$store.state['jalan-aing'].lokasi_aduan.city_name
      },
      set(value) {
        this.$store.commit(
    ...
    setValueSubDistrict: {
      get() {
        return this.$store.state['jalan-aing'].lokasi_aduan.district_name
      },
      set(value) {
        this.$store.commit(
    ...
    setValueVillage: {
      get() {
        return this.$store.state['jalan-aing'].lokasi_aduan.village_name
      },
      set(value) {
        this.$store.commit(
    ...
    isLocationPickerDisabled() {
      const lokasiAduan = this.$store.state['jalan-aing'].lokasi_aduan
      return (
        !lokasiAduan.city_name ||
        !lokasiAduan.district_name ||
        !lokasiAduan.village_name
      )
    },
  },
  created() {
  ...
  methods: {
    ...
    setAddressDetail(value) {
      this.$store.commit(
        'jalan-aing/SET_LOKASI_ADUAN_ADDRESS_DETAIL',
        value
      )
    },
