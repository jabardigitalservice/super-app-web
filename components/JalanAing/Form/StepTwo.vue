<template>
  <section class="grid grid-cols-1 gap-x-8 gap-y-6 mb-4">
    <div v-show="false" class="flex flex-col gap-2" name="Tipe Aduan">
...
export default {
  ...
  computed: {
    ...mapState('jalan-aing', ['informasi_aduan']),
    ...mapGetters('jalan-aing', ['categoriesOption', 'subCategoriesOption']),
    ...
    isAnonymous: {
      ...
      set(value) {
        this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_IS_ANONYMOUS', value)
      },
    },
    setTitle: {
      get() {
      ...
      set(value) {
        this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_TITLE', value)
      },
    },
    setValueReason() {
    ...
    setType: {
      ...
      set(value) {
        this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_TYPE', value)
      },
    },
    setValueCategory: {
      get() {
      ...
      set(value) {
        this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_CATEGORY', value)
    ...
    setValueSubCategory: {
      ...
      set(value) {
        this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_SUB_CATEGORY', value)
      },
    },
    setValueCategoryChildId: {
      ...
      set(value) {
        this.$store.commit(
          'jalan-aing/SET_INFORMASI_ADUAN_CATEGORY_CHILD_ID',
          value
        )
      },
    },
    setValueSubCategoryChildId: {
      ...
      set(value) {
        this.$store.commit(
          'jalan-aing/SET_INFORMASI_ADUAN_SUBCATEGORY_CHILD_ID',
          value
        )
      },
    },
  ...
  mounted() {
    // Fetch subcategories for jalan-aing category
    this.fetchSubCategories({ complaint_category_id: 'jalan-aing' })
  },
  methods: {
    ...
    setReason(value) {
      this.$store.commit('jalan-aing/SET_INFORMASI_ADUAN_REASON', value)
    },
  },
}
</script>
